...
trainloader = DataLoader(brkb_tr, batch_size=10, drop_last=True)
...
print(shortmodel(brkb_tr[0][0].reshape(1, 57, 2)))
...
# helpers.train(trainloader, shortmodel, optimizer, loss, 100, testloader, print_every=1)
